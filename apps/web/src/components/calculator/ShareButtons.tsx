  ...
  return (
    <div className="flex gap-2">
      ...
      <button
        ...
        className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-[#2AABEE] px-4 py-2.5 text-sm font-medium text-white transition-all hover:bg-[#229ED9]"
      >
      ...
      <button
        ...
        className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-[#25D366] px-4 py-2.5 text-sm font-medium text-white transition-all hover:bg-[#20BD5A]"
      >
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
